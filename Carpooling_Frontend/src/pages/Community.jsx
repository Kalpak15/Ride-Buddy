...
//   // Load Razorpay script when showRazorpayButton is true
//   useEffect(() => {
//     if (showRazorpayButton && formRef.current && !formRef.current.querySelector("script")) {
//       const script = document.createElement("script");
//       script.src = "https://checkout.razorpay.com/v1/payment-button.js";
//       script.async = true;
//       script.setAttribute("data-payment_button_id", "pl_Q12J47bbMRieht");
//       script.onload = () => {
//         console.log("Razorpay script loaded successfully");
//       };
//       script.onerror = () => {
//         console.error("Failed to load Razorpay script");
//         toast.error("Failed to load payment button. Please try again.");
//       };
...
//         setCurrentUserId(decoded.userId);
//         const response = await axios.get(
//           "http://localhost:3000/api/v1/payments/subscription-status",
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
...
//               <div className="mb-6">
//                 {showRazorpayButton ? (
//                   <form ref={formRef}></form> // Razorpay button will be injected here
//                 ) : (
//                   <p className="text-gray-600">Click "Pay with Razorpay" to proceed</p>
//                 )}
//               </div>
//               <div className="flex justify-end gap-4">
//                 <button
...
//                 </button>
//                 <button
//                   onClick={handleShowPaymentButton}
//                   className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2 transition-colors font-medium text-sm shadow-sm"
//                 >
//                   <CreditCard className="w-4 h-4" />
//                   Pay with Razorpay
...
//       script.async = true;
//       script.setAttribute("data-payment_button_id", "pl_Q12J47bbMRieht");
//       script.setAttribute("data-notes", JSON.stringify({ userId: currentUserId }));
//       script.onload = () => {
//         console.log("Razorpay script loaded successfully");
//       };
//       script.onerror = () => {
...
//       };
//     }
//   }, [showRazorpayButton, currentUserId]);
...
//       // Pass userId explicitly in the query parameter
//       const response = await axios.get(
//         `http://localhost:3000/api/v1/payments/subscription-status?userId=${userId}`,
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
...
//           <h2 className="text-3xl font-bold text-gray-900 mb-4">Premium Feature</h2>
//           <p className="text-gray-600 mb-8">
//             The RideBuddy Community is a premium feature available only to members.
//             Subscribe now to connect with other riders, share experiences, and get real-time updates!
//           </p>
//           <div className="space-y-4">
//             <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
...
//                     <button
//                       type="button"
//                       onClick={handlePaymentSuccess} // Temporary for testing
